...
class bayes_classifier : public data_splitter_extremum_dist<typename DistributionT::DataType, LabelT, GREATER> {
public:
...
protected:
  ...
  virtual void train_setup_for_each_label(queue& q) override {
    ...
    auto data_dim_pow2_rng_d2 = get_optimal_nd_range(this->_data_dim_pow2, this->_data_dim_pow2);
  ...
  virtual void train_for_each_label(queue& q, unsigned label_idx, matrix_t<DataType>& act_data) override {

...
template <int DIM>
inline void assert_rng_size_less_or_eq(const range<DIM>& r, SYCLIndexT high_size) {
...
template <>
inline void assert_rng_less_or_eq<TR, 2>(const range<2>& r, const range<2>& high_r) {
...
inline void assert_rng_less_or_eq(const range<2>& r, SYCLIndexT high0, SYCLIndexT high1) {
  assert_rng_less_or_eq(range<2>(access_rng<D>(r, 0), access_rng<D>(r, 1)), range<2>(high0, high1));
}

template <data_dim = LIN>
inline void assert_rng_less_or_eq(const range<3>& r, SYCLIndexT high0, SYCLIndexT high1, SYCLIndexT high2) {
...
template <class T> inline void assert_less_or_eq(T, T) {}
template <int DIM> inline void assert_rng_size_less_or_eq(range<DIM>, SYCLIndexT) {}
template <data_dim = LIN, int DIM> inline void assert_rng_less_or_eq(const range<DIM>&, const range<DIM>&) {}
template <data_dim = LIN> inline void assert_rng_less_or_eq(const range<1>&, SYCLIndexT) {}
template <data_dim = LIN> inline void assert_rng_less_or_eq(const range<2>&, SYCLIndexT, SYCLIndexT) {}
